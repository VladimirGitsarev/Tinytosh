...
public:
    ...
    void animateTransition(int prevScreen, int nextScreen, int effect, const Config& config, TimeService& timeService, const WeatherData& weather, const AirQualityData& aqi, const PcStats& pc, const CryptoData& crypto);
